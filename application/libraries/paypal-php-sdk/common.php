...
class ResultPrinter
{
    ...
    public static function printOutput($title, $objectName, $objectId = null, $request = null, $response = null, $errorMessage = null)
    {
        if (PHP_SAPI == 'cli') {
            ...
            if (self::$printResultCounter == 0) {
                include "header.html";
                echo '
                  <div class="row header"><div class="col-md-5 pull-left"><br /><a href="'.base_url('/').'"><h1 class="home">&#10094;&#10094; Back</h1></a><br /></div> <br />
        ...
        <div class="panel panel-default">
            ...
            echo '<div class="row hidden-xs hidden-sm hidden-md"><div class="col-md-12"><h4>Request Object</h4>';
            self::printObject($request);
            echo '</div><div class="col-md-12"><h4 class="'. ($errorMessage ? 'error' : '') .'">Response Object</h4>';
    ...
    public static function printError($title, $objectName, $objectId = null, $request = null, $exception = null)
    {
        ...
        self::printOutput($title, $objectName, $objectId, $request, $data, false);
    }
