                ...
                <div class="footer-content">
                  ...
                  <div class="contact">
                    ...
                    <p>
                      ...
                      <a href="mailto:<?= $this->db->get_where('tbl_web_settings', array('id' => '1'))->row()->contact_email ?>"><?= $this->db->get_where('tbl_web_settings', array('id' => '1'))->row()->contact_email ?></a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="single-footer mt-10">
                ...
                <div class="footer-content">
                  ...
                  ?>
                    <a href="<?= $this->db->get_where('tbl_web_settings', array('id' => '1'))->row()->ios_app_url ?>" target="_blank"><img src="<?= base_url('assets/images/app-store.png') ?>" alt=""></a>
                </div>
              <?php } ?>
              </div>
            </div>
