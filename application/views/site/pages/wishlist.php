      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php 
            ...
            ?>
            <center>
              <img src="<?=base_url('assets/img/empty_wishlist.png')?>" style="width: 200px;">
              <h2 style="font-size: 18px;font-weight: 500;color: #888;text-transform: capitalize;"><?=$this->lang->line('empty_wishlist_lbl')?></h2>
              <br/>
              <a href="<?=base_url('/')?>"><img src="<?=base_url('assets/images/continue-shopping-button.png')?>" style="width: 200px;height: 100%;"></a>
            </center>
            <?php
          } ?>
        </div>
