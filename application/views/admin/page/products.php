            ...
            <form method="post" action="">
                ...
                <div class="dropdown" style="float:right">
                  ...
                  <ul class="dropdown-menu" style="right:0;left:auto;">
                    <li><a href="javascript:void(0)" class="actions" data-action="enable"><?=$this->lang->line('enable_lbl')?></a></li>
                    <li><a href="javascript:void(0)" class="actions" data-action="disable"><?=$this->lang->line('disable_lbl')?></a></li>
                    <li><a href="javascript:void(0)" class="actions" data-action="delete"><?=$this->lang->line('delete_lbl')?></a></li>
                    <li><a href="javascript:void(0)" class="actions" data-action="set_today_deal"><?=$this->lang->line('set_todays_deal_lbl')?></a></li>
