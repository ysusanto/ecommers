                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" name="selling_price" id="selling_price" readonly="" value="<?php if(isset($product)){ echo $product[0]->selling_price;}else{ echo '0';} ?>" class="form-control" placeholder="">
                        </div>
                      </div>
                  </div>
                </div>
