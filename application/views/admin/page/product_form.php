    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom">
        <form action="<?php if (!isset($product)) {
                        echo site_url('admin/product/addForm') . '?redirect=' . $redirect;
                      } else {
                        echo site_url('admin/product/editForm/' . $product[0]->id) . '?redirect=' . $redirect;
                      } ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
            <div class="section-body">
              ...
              <div class="section_container" style="padding: 10px;border:1px solid #d7d7d7">
                ...
                <div class="row">
                  <div class="col-md-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" name="title" id="product_title" value="<?php if (isset($product)) {
                                                                                    echo $product[0]->product_title;
                                                                                  } ?>" class="form-control" placeholder="<?= $this->lang->line('title_place_lbl') ?>" required>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <select name="category_id" class="select2" required="">
                          ...
                          ?>
                            <option value="<?= $value->id ?>" <?php if (isset($product) && $product[0]->category_id == $value->id) {
                                                                echo 'selected';
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="product_desc" id="product_desc" class="form-control" rows="2"><?php if (isset($product)) {
                                                                                                    echo $product[0]->product_desc;
                                                                                                  } ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="product_features_desc" id="product_features_desc" required="" class="form-control"><?php if (isset($product)) {
                                                                                                                          echo $product[0]->product_features;
                                                                                                                        } ?></textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="product_mrp" id="product_mrp" value="<?php if (isset($product)) {
                                                                                        echo $product[0]->product_mrp;
                                                                                      } else {
                                                                                        echo '0';
                                                                                      } ?>" class="form-control" placeholder="" onkeypress="return isNumberKey(event)" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="selling_price" id="selling_price" readonly="" value="<?php if (isset($product)) {
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        ...
                        <select name="offer_id" id="offer_id" class="select2">
                          ...
                          ?>
                            <option value="<?= $value->id ?>" <?php if (isset($product) && $product[0]->offer_id == $value->id) {
                                                                echo 'selected';
                                                              } ?>><?= $value->offer_title ?></option>
                          <?php
                          }
                          ?>
                        </select>
                ...
                <div class="row">
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="max_unit_buy" id="max_unit_buy" value="<?php if (isset($product)) {
                                                                                          echo $product[0]->max_unit_buy;
                                                                                        } else {
                                                                                          echo '1';
                                                                                        } ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57 " class="form-control" required="required" placeholder="1">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-xs-12">
                    ...
                    <?php } else { ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" name="delivery_charge" id="delivery_charge" value="<?php if (isset($product)) {
                                                                                                  echo $product[0]->delivery_charge;
                                                                                                } else {
                                                                                                  echo '0';
                                                                                                } ?>" class="form-control" placeholder="<?= $this->lang->line('delivery_charge_lbl') ?>" required>
                        </div>
                      </div>
                    <?php } ?>
                ...
                <div class="row color" style="display: none;">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-5">
                        <input type="text" name="product_color" id="product_color" value="<?php if (isset($product)) {
                                                                                            echo $color_name;
                                                                                          } else {
                                                                                            echo 'White';
                      ...
                      <div class="col-md-5">
                        <input type="text" name="color_code" id="color_code" value="<?php if (isset($product)) {
                                                                                      echo $color_code;
                                                                                    } ?>" class="form-control jscolor" data-jscolor="{preset:'large', position:'top', borderColor:'#999', insetColor:'#FFF', backgroundColor:'#ddd'}" placeholder="Enter product color">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row size" style="display: none;">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="product_size" id="product_size" value="<?php if (isset($product)) {
                                                                                          echo $product[0]->product_size;
                                                                                        } ?>" class="form-control" placeholder="<?= $this->lang->line('product_size_place_lbl') ?>">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <div class="fileupload_block">
                          ...
                          <div class="fileupload_img"><img type="image" src="<?php
                                                                              if (!isset($product) || $product[0]->size_chart == '') {
                                                                                echo base_url('assets/images/no-image-1.jpg');
                                                                              } else {
                                                                                echo IMG_PATH . $product[0]->size_chart;
                                                                              }
                        ...
                        <div class="fileupload_block">
                          ...
                          <div class="fileupload_img"><img type="image" src="<?php
                                                                              if (!isset($product)) {
                                                                                ...
                                                                                echo IMG_PATH . $product[0]->featured_image;
                                                                              }
                                                                              ?>" alt="product image" style="max-width: 100%;max-height: 100%;width: auto;height: 90px;" /></div>
                        </div>
                      </div>
                        ...
                        <div class="fileupload_block">
                          ...
                          <div class="fileupload_img"><img type="image" src="<?php
                                                                              if (!isset($product)) {
                                                                                ...
                                                                                echo IMG_PATH . $product[0]->featured_image2;
                                                                              }
                                                                              ?>" alt="product image" style="max-width: 100%;max-height: 100%;width: auto;height: 90px;" /></div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" name="seo_title" id="seo_title" value="<?php if (isset($product)) {
                                                                                    echo $product[0]->seo_title;
                                                                                  } ?>" class="form-control" placeholder="<?= $this->lang->line('seo_title_place_lbl') ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <textarea name="seo_meta_description" placeholder="<?= $this->lang->line('seo_meta_place_lbl') ?>" id="seo_meta_description" class="form-control" rows="2"><?php if (isset($product)) {
                                                                                                                                                                                      echo $product[0]->seo_meta_description;
                                                                                                                                                                                    } ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" name="seo_keywords" id="seo_keywords" data-role="tagsinput" value="<?php if (isset($product)) {
                                                                                                                echo $product[0]->seo_keywords;
                                                                                                              } ?>" class="form-control" placeholder="<?= $this->lang->line('seo_keyword_place_lbl') ?>">
                      </div>
                    </div>
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        if (res != '') {
          ...
          $(".product_features").find(".row").hide();
          $(".product_features").find("input").attr("required", false);
          $(".product_features").find("select").attr("required", false);
          ...
          $.each(res_arr, function(index, value) {
            ...
            $(".product_features").find("." + value).find("input").attr("required", true);
            $(".product_features").find("." + value).find("select").attr("required", true);

            $(".product_features").find("." + value).find("input[name='size_chart']").attr("required", false);
  ...
  $(document).ready(function(e) {
    ...
    $("input[name='product_mrp']").keyup(function(e) {
      if ($(this).val() != '') {
        ...
        if (offer_id != 0) {
          var href = '<?php echo site_url('admin/product/calculate_offer/') ?>' + offer_id + '/' + _mrp;

          $.ajax({
            type: 'GET',
            url: href,
            success: function(res) {
              $('#offer_id option[value="' + offer_id + '"]').prop('selected', true);
              $obj = $.parseJSON(res);
              $("input[name='selling_price']").val($obj.selling_price);
    ...
    $("input[name='max_unit_buy']").on("blur", function(e) {
