  ...
  <center style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#e1e5e8;">
    <div style="max-width:600px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;">
      <table align="center" cellpadding="0" style="border-spacing:0;color:#333333;margin:0 auto;width:100%;max-width:600px;">
        <tbody>
          <tr>
            <td align="center" class="vervelogoplaceholder" height="143" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;height:143px;vertical-align:middle;" valign="middle"><span class="sg-image"><img alt="App Logo" height="34" src="<?php echo base_url().'assets/images/'.APP_LOGO?>" style="border-width: 0px; width: auto; height: auto;" width="100"></a></span></td>
          </tr>
          <!-- Start of Email Body-->
          <tr>
            <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#ffffff;">
              ...
              <table style="border-spacing:0;" width="100%">
                <tbody>
                  <tr>
                    <td align="center" class="inner" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;" valign="middle"><span class="sg-image"><img alt="verification_icon" class="banner" height="93" src="<?php echo base_url().'assets/images/forgotten_login.png'?>" style="border-width: 0px; margin-top: 30px; width: 130px; height: auto;"></span></td>
                  </tr>
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        <p class="h1 center" style="margin:0;text-align:center;font-weight:500;font-size:25px;margin-bottom:26px;"><?=$this->lang->line('reset_pass_heading_lbl')?></p>
                        <!--[if (gte mso 9)|(IE)]><![endif]-->

                        <p class="h1 center" style="margin:5px 0px 20px;font-weight: 400;color: rgb(161, 168, 173);text-align:center;font-size:20px;"><?=$this->lang->line('hi_lbl')?>, <?=$name?></p>

                        <p class="h1 center" style="margin:5px 0px 20px;font-weight: 400;color: rgb(161, 168, 173);text-align:center;font-size:18px;"><?=$this->lang->line('reset_pass_sort_desc_lbl')?></p>

                        <p class="h1 center" style="margin:5px 0px 20px;color: rgb(161, 168, 173);text-align:center;font-size:16px;"><?=$this->lang->line('reset_pass_click_link_desc_lbl')?></p>

                        <a href='<?=$reset_url?>' target="_blank" style="text-decoration: none;outline: none;margin:5px 0px 20px;background:#363f4d;box-shadow:none;border:0;border-radius:4px;color:#fff;display:inline-block;font-size:14px;font-weight:500;height:38px;line-height:38px;overflow:hidden;padding:0 20px;text-shadow:none;text-transform:capitalize;text-align:center;vertical-align:middle;white-space:nowrap"><?=$this->lang->line('reset_btn')?></a>
