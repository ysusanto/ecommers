  ...
  <center style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#e1e5e8;">
    <div style="max-width:600px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;">
      <table align="center" cellpadding="0" style="border-spacing:0;color:#333333;margin:0 auto;width:100%;max-width:600px;">
        <tbody>
          <tr>
            <td align="center" class="vervelogoplaceholder" height="143" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;height:143px;vertical-align:middle;" valign="middle"><span class="sg-image"><img alt="App Logo" src="<?php echo base_url().'assets/images/'.APP_LOGO?>" style="border-width: 0px; width: auto; height: auto;" ></a></span></td>
          </tr>
          <!-- Start of Email Body-->
          <tr>
            <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#ffffff;">
              ...
              <table style="border-spacing:0;" width="100%">
                <tbody>
                  <tr>
                    <td align="center" class="inner" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;" valign="middle"><span class="sg-image"><img alt="verification_icon" class="banner" src="<?php echo base_url().'assets/images/verification_icon.png'?>" style="border-width: 0px; margin-top: 30px; width: 130px; height: auto;"></span></td>
                  </tr>
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        <p class="h1 center" style="margin:0;text-align:center;font-weight:100;font-size:25px;margin-bottom:26px;"><?=$this->lang->line('email_verify_heading_lbl')?></p>
                        <!--[if (gte mso 9)|(IE)]><![endif]-->


                        <p class="h1 center" style="margin:20px 0px;font-weight: 400;color: rgb(161, 168, 173);text-align:center;font-size:18px;"><?=$this->lang->line('verify_code_lbl')?>: <span style="font-weight: 500;color: #000"><?=$otp?></span></p>
