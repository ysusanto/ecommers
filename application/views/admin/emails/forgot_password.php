                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                            <center>
                              <p class="h1 center" style="margin:0;text-align:center;font-weight:500;font-size:25px;margin-bottom:26px;"><?=$this->lang->line('forgot_pass_heading_lbl')?></p>
                              <!--[if (gte mso 9)|(IE)]><![endif]-->

                              <p class="h1 center" style="margin:5px 0px 20px;font-weight: 400;color: rgb(161, 168, 173);text-align:center;font-size:18px;"><?=$this->lang->line('you_new_password_lbl')?>: <span style="font-weight: 500;color: #000"><?=$password?></span></p>
