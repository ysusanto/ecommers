...
-- Dumping data for table ecommers.tbl_order_items: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_order_status: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_rating: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_recent_viewed: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_transaction: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_users: ~1 rows (approximately)
