...
-- Dumping data for table ecommers.tbl_addresses: ~0 rows (approximately)
...
INSERT INTO `tbl_addresses` (`id`, `user_id`, `pincode`, `building_name`, `road_area_colony`, `id_ro_city`, `city`, `district`, `state`, `id_ro_province`, `country`, `landmark`, `name`, `email`, `mobile_no`, `alter_mobile_no`, `address_type`, `is_default`, `created_at`) VALUES
	(1, 1, '11891', 'jl keselamatan no 1a', 'tebet', '', 'Semarang', '', 'Jawa tengah', '', 'Indonesia', '', 'ari', 'yohanes.ari90@gmail.com', '082112585009', '', '1', 'true', '1617249089');
...
-- Dumping data for table ecommers.tbl_bank_details: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_banner: ~4 rows (approximately)
...
-- Dumping data for table ecommers.tbl_cart: ~2 rows (approximately)
...
-- Dumping data for table ecommers.tbl_category: ~7 rows (approximately)
...
-- Dumping data for table ecommers.tbl_contact_list: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_contact_sub: ~2 rows (approximately)
DELETE FROM `tbl_contact_sub`;
/*!40000 ALTER TABLE `tbl_contact_sub` DISABLE KEYS */;
...
-- Dumping data for table ecommers.tbl_coupon: ~3 rows (approximately)
...
-- Dumping structure for table ecommers.tbl_courier
...
-- Dumping data for table ecommers.tbl_courier: ~0 rows (approximately)
DELETE FROM `tbl_courier`;
...
-- Dumping data for table ecommers.tbl_faq: ~9 rows (approximately)
DELETE FROM `tbl_faq`;
...
-- Dumping data for table ecommers.tbl_logs: ~0 rows (approximately)
...
INSERT INTO `tbl_mst_courier` (`id`, `code`, `name`, `path_img`, `parent`, `type`, `orderby`, `created_at`, `created_by`) VALUES
	...
	(10, 'pos-kilat', 'Pos Kilat Khusus', NULL, 3, 1, NULL, '2021-04-03 18:13:30', 1);
...
-- Dumping data for table ecommers.tbl_offers: ~6 rows (approximately)
...
-- Dumping data for table ecommers.tbl_order_details: ~0 rows (approximately)
DELETE FROM `tbl_order_details`;
/*!40000 ALTER TABLE `tbl_order_details` DISABLE KEYS */;
INSERT INTO `tbl_order_details` (`id`, `user_id`, `coupon_id`, `order_unique_id`, `order_address`, `total_amt`, `discount`, `discount_amt`, `payable_amt`, `new_payable_amt`, `refund_amt`, `refund_per`, `order_date`, `delivery_date`, `order_status`, `delivery_charge`, `pincode`, `building_name`, `road_area_colony`, `city`, `district`, `state`, `country`, `landmark`, `name`, `email`, `mobile_no`, `alter_mobile_no`, `address_type`, `id_mst_courier`, `is_seen`) VALUES
	(1, 1, 0, 'ORDv6l9K42h688', 1, 67.22, '0', 0, 68.22, 68.22, 0, 0, '1618028339', '1618597800', 4, '1', '11891', 'jl keselamatan no 1a', 'tebet', 'jakarta selatan', '', 'tebet', 'Indonesia', '', 'ari', 'yohanes.ari90@gmail.com', '082112585009', '', '1', 0, 1),
	(2, 1, 0, 'ORDcgv8EwPs733', 1, 44000000, '0', 0, 44, 44, 0, 0, '1618152955', '1618757755', 1, '', '11891', 'jl keselamatan no 1a', 'tebet', 'Semarang', '', 'Jawa tengah', 'Indonesia', '', 'ari', 'yohanes.ari90@gmail.com', '082112585009', '', '1', 0, 0);
...
-- Dumping data for table ecommers.tbl_order_items: ~3 rows (approximately)
...
INSERT INTO `tbl_order_items` (`id`, `order_id`, `user_id`, `product_id`, `product_title`, `product_qty`, `product_mrp`, `product_price`, `you_save_amt`, `product_size`, `total_price`, `delivery_charge`, `pro_order_status`) VALUES
	(1, 1, 1, 74, 'BIKAJI ALL-IN-ONE KUCH-KUCH 1KG,MOONG DAL 400G', 2, 10, 7, 3, '', 14, 1, 4),
	(2, 1, 1, 84, 'Alloy Jewel Set  (Gold)', 2, 15, 12, 3, '', 24, 0, 4),
	(3, 1, 1, 32, 'Boyfriend Women Black Jeans', 2, 14.61, 14.61, 0, ' M', 29.22, 0, 4),
	(4, 2, 1, 92, 'Asus ROG Strix G Core i7 9th Gen - (16 GB/512 GB SSD/Windows 10 Home/4 GB Graphics/NVIDIA Geforce GTX 1650) G531GT-AL018T Gaming Laptop  (15.6 inch, B', 1, 25000000, 20000000, 5000000, '', 20000000, 0, 1),
	(5, 2, 1, 93, 'Apple MacBook Air Core i5 5th Gen - (8 GB/128 GB SSD/Mac OS Sierra) MQD32HN/A A1466  (13.3 inch, Silver, 1.35 kg)', 1, 30000000, 24000000, 6000000, '', 24000000, 0, 1);
...
-- Dumping data for table ecommers.tbl_order_status: ~8 rows (approximately)
DELETE FROM `tbl_order_status`;
...
INSERT INTO `tbl_order_status` (`id`, `order_id`, `user_id`, `product_id`, `status_title`, `status_desc`, `created_at`) VALUES
	(1, 1, 1, 0, '1', 'Your Order has been placed.', '1618028341'),
	(2, 1, 1, 74, '1', 'Your Order has been placed.', '1618028341'),
	(3, 1, 1, 84, '1', 'Your Order has been placed.', '1618028341'),
	(4, 1, 1, 32, '1', 'Your Order has been placed.', '1618028341'),
	(5, 1, 1, 0, '4', 'aaa', '1618028494'),
	(6, 1, 1, 74, '4', 'aaa', '1618028494'),
	(7, 1, 1, 84, '4', 'aaa', '1618028494'),
	(8, 1, 1, 32, '4', 'aaa', '1618028494'),
	(9, 2, 1, 0, '1', 'Your Order has been placed.', '1618152956'),
	(10, 2, 1, 92, '1', 'Your Order has been placed.', '1618152956'),
	(11, 2, 1, 93, '1', 'Your Order has been placed.', '1618152956');
...
CREATE TABLE IF NOT EXISTS `tbl_password_reset` (
  ...
  `request_on` varchar(150) NOT NULL,
  `expires_in` varchar(150) NOT NULL,
  `ip_address` varchar(40) NOT NULL,
  `status` int(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ecommers.tbl_password_reset: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tbl_product` (
  ...
  `delivery_charge` float NOT NULL,
  `weight` int(11) DEFAULT 0 COMMENT 'dalam gram',
...
-- Dumping data for table ecommers.tbl_product_images: ~302 rows (approximately)
...
INSERT INTO `tbl_product_images` (`id`, `parent_id`, `image_file`, `type`, `status`) VALUES
	...
	(449, 92, '02022021121811_92127_2_.png', 'product', 1),
	(450, 92, '02022021121811_17854_2_.png', 'product', 1),
	(451, 92, '02022021121811_1497_2_.png', 'product', 1),
	(452, 92, '02022021121811_90703_2_.png', 'product', 1),
	(453, 93, '02022021123955_39199_2.png', 'product', 1),
	(454, 93, '02022021123955_44_2.png', 'product', 1),
	(455, 93, '02022021123955_79544_2.png', 'product', 1),
...
CREATE TABLE IF NOT EXISTS `tbl_province_ro` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_ro_province` varchar(5) NOT NULL DEFAULT '0',
...
-- Dumping data for table ecommers.tbl_rating: ~1 rows (approximately)
...
-- Dumping data for table ecommers.tbl_recent_viewed: ~3 rows (approximately)
...
-- Dumping data for table ecommers.tbl_refund: ~4 rows (approximately)
DELETE FROM `tbl_refund`;
/*!40000 ALTER TABLE `tbl_refund` DISABLE KEYS */;
INSERT INTO `tbl_refund` (`id`, `bank_id`, `user_id`, `order_id`, `order_unique_id`, `product_id`, `product_title`, `product_amt`, `refund_pay_amt`, `refund_per`, `gateway`, `refund_reason`, `last_updated`, `request_status`, `cancel_by`, `created_at`) VALUES
	(2, 1, 2, 4, 'ORDN2Flsq00462', 54, 'Drogo M Running Shoe For Men  (Navy)', 53.04, 26.53, 26.51, 'stripe', 'I buy from another place.', '1612350088', 2, 0, '1612349887'),
	(3, 1, 2, 4, 'ORDN2Flsq00462', 41, 'Sony Bravia R202F 80cm (32 inch) HD Ready LED TV  (KLV-32R202F)', 239.15, 119.57, 119.58, 'stripe', 'I can\'t effort this product.', '1612350301', 0, 0, '1612350301'),
...
-- Dumping data for table ecommers.tbl_shipping: ~4 rows (approximately)
DELETE FROM `tbl_shipping`;
/*!40000 ALTER TABLE `tbl_shipping` DISABLE KEYS */;
INSERT INTO `tbl_shipping` (`id`, `id_mst_courier`, `created_at`) VALUES
	(1, 4, '2021-04-11 15:18:11'),
	(2, 5, '2021-04-11 15:18:11'),
	(3, 8, '2021-04-11 15:18:12'),
	(4, 10, '2021-04-11 15:18:12');
...
-- Dumping data for table ecommers.tbl_status_title: ~5 rows (approximately)
DELETE FROM `tbl_status_title`;
/*!40000 ALTER TABLE `tbl_status_title` DISABLE KEYS */;
...
-- Dumping data for table ecommers.tbl_sub_category: ~19 rows (approximately)
DELETE FROM `tbl_sub_category`;
...
-- Dumping data for table ecommers.tbl_transaction: ~1 rows (approximately)
...
INSERT INTO `tbl_transaction` (`id`, `user_id`, `email`, `order_id`, `order_unique_id`, `gateway`, `payment_amt`, `payment_id`, `razorpay_order_id`, `date`, `status`) VALUES
	(1, 1, 'yohanes.ari90@gmail.com', 1, 'ORDv6l9K42h688', 'cod', '68.22', '0', '0', '1618028341', 1),
	(2, 1, 'yohanes.ari90@gmail.com', 2, 'ORDcgv8EwPs733', 'cod', '44,000,000.00', '0', '0', '1618152956', 1);
...
-- Dumping data for table ecommers.tbl_users: ~0 rows (approximately)
...
-- Dumping data for table ecommers.tbl_verify_code: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tbl_web_settings` (
  ...
  `id_ro_subdistrict` varchar(5) NOT NULL,
  `subdistrict` varchar(60) NOT NULL,
  `id_ro_district` varchar(5) NOT NULL,
  ...
  `g_captcha` varchar(10) NOT NULL DEFAULT 'false',
...
-- Dumping data for table ecommers.tbl_wishlist: ~0 rows (approximately)
